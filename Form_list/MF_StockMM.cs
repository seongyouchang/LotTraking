...
namespace Form_list
{
    public partial class MF_StockMM : BaseChlidForm
    {
        ...
        private void StockMMRec2_Load(object sender, EventArgs e)
        {
            ...
            dtGrid.Columns.Add("MATLOTNO", typeof(char));
            ...
            dtGrid.Columns.Add("ROWINDATE", typeof(char));    
            ...
            GridStockMMRec2.Columns["MATLOTNO"].HeaderText      = "LOTNO";
            GridStockMMRec2.Columns["WHCODE"].HeaderText        = "창고";
            GridStockMMRec2.Columns["STOCKQTY"].HeaderText      = "재고수량";
            GridStockMMRec2.Columns["ROWUNIT"].HeaderText       = "단위";
            GridStockMMRec2.Columns["ROWACCOUNT"].HeaderText    = "거래처명";
            GridStockMMRec2.Columns["ROWINDATE"].HeaderText     = "입고일자";
        ...
        public override void Inquire()
        {
            ...
            try
            {
                ...
                Adapter = new SqlDataAdapter("MF_StockMM_S", Connect);
