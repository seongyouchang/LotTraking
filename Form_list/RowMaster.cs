...
namespace Form_list
{
    public partial class RowMaster : BaseChlidForm
    {
        ...
        private void Form03_UserMaster_Load(object sender, EventArgs e)
        {
            ...
            dtGrid.Columns.Add("iLROW", typeof(float));                    // 원자재 번호
            ...
            dtGrid.Columns.Add("ROWEA", typeof(float));                   //원자재 재고 개수
            ...
            GridRowMaster.Columns[4].Width = 00;
        ...
        public override void Inquire()
        {
            ...
            try
            {
                ...
                Adapter.SelectCommand.Parameters.AddWithValue("ROWSTOCK", textRowStock.Text);
